...
1. The [HUD CSV export](https://files.hudexchange.info/resources/documents/HMIS-CSV-Format-Specifications-2024.pdf) - Every HMIS should be able to export this regardless of HMIS vendor.
...
The [`clarity.looker`]{https://github.com/COHHIO/clarity.looker} package provides a setup function \link[clarity.looker]{setup_looker} for setting up an API connection with the Clarity Looker instance. An API key & secret will need to be requested.
